\documentclass[10pt,a4paper,showframe]{scrbook}
...
\usepackage[showframe,paper=a4paper,top=1cm,bottom=1cm,inner=2cm,outer=2cm]{geometry}% http://ctan.org/pkg/geometry
