...
<node CREATED="1387439443902" ID="Freemind_Link_64086279" MODIFIED="1390983739071" TEXT="introduce surbs/murbs"/>
<node CREATED="1390986172845" ID="ID_1509298173" MODIFIED="1390986266025" TEXT="reencrypt (xoring?) with multiple key lengths to avoid tagging"/>
<node CREATED="1390986858009" ID="ID_390257209" MODIFIED="1390986886604" TEXT="mime headers to be used to specify vortex"/>
</node>
...
<node CREATED="1434003061322" ID="ID_53174905" MODIFIED="1434003068766" TEXT="Cypherpunk-Remailer">
<node CREATED="1434003069280" ID="ID_1770934285" MODIFIED="1434003091531" TEXT="Grunds&#xe4;tzlich ein Anonymisierender Remailer"/>
<node CREATED="1434003194377" ID="ID_529164592" MODIFIED="1434003200949" TEXT="Typ-I-Remailer"/>
<node CREATED="1434003092718" ID="ID_1809357621" MODIFIED="1434003109690" TEXT="Kann kaskadiert werden"/>
<node CREATED="1434003247495" ID="ID_742095567" MODIFIED="1434003266244" TEXT="Funktioniert mit Traditionellem Email-Client"/>
</node>
<node CREATED="1434003204632" ID="ID_1178898986" MODIFIED="1434003217140" TEXT="Mixmaster-Remailer">
<node CREATED="1434003218551" ID="ID_202443790" MODIFIED="1434003225699" TEXT="Typ-II-Remailer"/>
<node CREATED="1434003269383" ID="ID_1003027524" MODIFIED="1434003276117" TEXT="Dedizierter Client"/>
<node CREATED="1434003332682" ID="ID_500333922" MODIFIED="1434003349831" TEXT="Poolt nachrichten und sendet sie zuf&#xe4;llig weiter"/>
</node>
<node CREATED="1434003875906" ID="ID_1144613424" MODIFIED="1434003884318" TEXT="Mixminion-Remailer">
<node CREATED="1434003885826" ID="ID_547616835" MODIFIED="1434003893694" TEXT="Typ-III-Remailer"/>
</node>
<node CREATED="1434010085062" ID="ID_955757168" MODIFIED="1434010093154" TEXT="Pseudonymous-Remailer">
<node CREATED="1434010093637" ID="ID_1463214172" MODIFIED="1434010098914" TEXT="anon.penet.fi"/>
<node CREATED="1434010099333" ID="ID_1458969020" MODIFIED="1434010116193" TEXT="Auch als Typ-0-remailer bezeichnet"/>
</node>
</node>
...
<node CREATED="1389716354515" ID="Freemind_Link_107512087" MODIFIED="1391006341236" TEXT="Should have multiple MURBs"/>
...
<node CREATED="1389852866801" ID="ID_71553329" MODIFIED="1390983874404" TEXT="A single Request (May need other blocks to make sense)"/>
</node>
<node CREATED="1389853112202" ID="ID_82013832" MODIFIED="1389853119206" TEXT="set">
<node CREATED="1389853120166" ID="ID_410777275" MODIFIED="1390983831488" TEXT="One or more Blocks which ar ligically connected (belong together)"/>
</node>
<node CREATED="1390983767831" ID="ID_593639636" MODIFIED="1390983771590" TEXT="Message">
<node CREATED="1390983781067" ID="ID_1509501585" MODIFIED="1390983815045" TEXT="One or more sets"/>
</node>
<node CREATED="1389852978893" ID="ID_1180732671" MODIFIED="1390983761785" TEXT="Mail">
<node CREATED="1389853068654" ID="ID_304989899" MODIFIED="1390983919083" TEXT="Content to be transmitted to the destinator"/>
</node>
...
<node CREATED="1390986587619" ID="ID_125325483" MODIFIED="1390986591519" TEXT="Address">
<node CREATED="1390986595333" ID="ID_710279073" MODIFIED="1390986614163" TEXT="Binary String of variable length"/>
<node CREATED="1390986622204" ID="ID_1978876836" MODIFIED="1390986650550" TEXT="Has a MURB associated to it"/>
</node>
<node CREATED="1390986893898" ID="ID_961983667" MODIFIED="1390986902665" TEXT="Vortex">
<node CREATED="1390986905403" ID="ID_1345804651" MODIFIED="1390986945136" TEXT="A bunch of messages related to a delivery of a mail"/>
</node>
</node>
</node>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    <p>
      # Asym Encrypted with Public key of recipient
    </p>
    <p>
    ...
    <p>
      MessageKeyType_length:MessageKeyType:MessageKeyType_size:MessageKey #symetric key for encyption of subsequent blocks
    </p>
    <p>
...
<node CREATED="1433837535212" ID="ID_1701641352" MODIFIED="1433837541616" TEXT="BIG NONO"/>
</node>
...
<node CREATED="1389771419599" ID="ID_237670027" MODIFIED="1391001341181" TEXT="DC2TransmitBlock">
<richcontent TYPE="NOTE"><html>
  <head>
...
<richcontent TYPE="NOTE"><html>
  ...
  <body>
    ...
    <p>
      Message_type (2 Byte) -&gt; &quot;MR&quot;
    </p>
    <p>
      Version(2 Byte)
    </p>
    <p>
      MessageID_length:MessageID # MessageID
    </p>
    <p>
    ...
    <p>
      EmbededCryptopuzzle_size(2 Bytes): embededCryptopuzzle
    </p>
    <p>
      # FIXME reencryption message request (must add CP block to message)
    </p>
    <p>
...
<icon BUILTIN="button_ok"/>
<node CREATED="1433837580224" ID="ID_700649696" MODIFIED="1433837589980" TEXT="Just place rubish at the end"/>
</node>
<node CREATED="1390985598967" ID="ID_1837627382" MODIFIED="1390985604224" TEXT="headerBlock"/>
<node CREATED="1390986360274" ID="ID_777672887" MODIFIED="1391001245216" TEXT="RRTuples">
<node CREATED="1389771540229" ID="ID_961833612" MODIFIED="1433840729743" TEXT="capabilitiesRequestBlock">
<richcontent TYPE="NOTE"><html>
  <head>
  ...
  <body>
    ...
    <p>
      lifetime_epoch(8 Byte)
    </p>
  </body>
</html></richcontent>
<icon BUILTIN="button_ok"/>
</node>
<node CREATED="1389771748821" ID="ID_1164848743" MODIFIED="1390986369587" TEXT="capabilitiesReplyBlock">
<richcontent TYPE="NOTE"><html>
  <head>
...
<node CREATED="1390983599776" ID="ID_1328814591" MODIFIED="1390983643192" TEXT="Should be used as this is the standard in MIME"/>
</node>
<node CREATED="1390983582148" ID="ID_1469323569" MODIFIED="1390983592070" TEXT="Base91-encoding"/>
<node CREATED="1390983592592" ID="ID_1725616594" MODIFIED="1390983595166" TEXT="yENc"/>
</node>
</node>
<node CREATED="1390986394836" ID="ID_340056023" MODIFIED="1390998896532" TEXT="AddressRequestBlock">
<node CREATED="1390986742583" ID="ID_1235346712" MODIFIED="1390986754128" TEXT="Must be signed with an identity"/>
<node CREATED="1390986764104" ID="ID_1813436328" MODIFIED="1390986784057" TEXT="On renewal identity must match old identity"/>
<node CREATED="1390998493579" ID="ID_1191921377" MODIFIED="1390998540676" TEXT="Must provide at least one MURB"/>
</node>
<node CREATED="1390986411442" ID="ID_241536712" MODIFIED="1390986555069" TEXT="AddressReplyBlock"/>
<node CREATED="1390997782007" ID="ID_1062024422" MODIFIED="1390997796110" TEXT="BandwidthRequestBlock"/>
<node CREATED="1390997803544" ID="ID_1334330728" MODIFIED="1390997812983" TEXT="BandwidthReplyBlock"/>
<node CREATED="1390999836253" ID="ID_117874521" MODIFIED="1391003735339" TEXT="IdentityRequestBlock">
<richcontent TYPE="NOTE"><html>
  <head>
...
<node CREATED="1390997122009" ID="ID_561495402" MODIFIED="1390997135752" TEXT="Embedding of blocks">
<node CREATED="1390997136493" ID="ID_1539353147" MODIFIED="1390997148490" TEXT="Should be embedded as attachments">
<node CREATED="1390997392890" ID="ID_1889918142" MODIFIED="1390997401533" TEXT="Encoding base64"/>
</node>
<node CREATED="1390997150042" ID="ID_1368435034" MODIFIED="1390997156033" TEXT="Should be binary"/>
<node CREATED="1390997157491" ID="ID_337528450" MODIFIED="1390997312517" TEXT="Should not be identifiable">
<node CREATED="1390997314132" ID="ID_350855055" MODIFIED="1390997333790" TEXT="No AV/MUA blocked Mime types"/>
<node CREATED="1390997336404" ID="ID_611654626" MODIFIED="1390997347731" TEXT="No recognisable header"/>
</node>
</node>
<node CREATED="1391002373729" ID="ID_1607353480" MODIFIED="1391002376880" TEXT="Numbers">
<node CREATED="1391002377434" ID="ID_963441724" MODIFIED="1391002382348" TEXT="Big-endian">
<node CREATED="1391002382730" ID="ID_1730357271" MODIFIED="1391002393182" TEXT="As in IP-Protocol specified"/>
</node>
</node>
<node CREATED="1391003380321" ID="ID_1599639940" MODIFIED="1391003385189" TEXT="Encryption">
<node CREATED="1391003385883" ID="ID_347188496" MODIFIED="1391003390625" TEXT="Symetric">
<node CREATED="1391003393433" ID="ID_479568098" MODIFIED="1391003399892" TEXT="Must use CBC"/>
</node>
</node>
</node>
...
<node CREATED="1390984208970" ID="ID_971815805" MODIFIED="1390984256239" TEXT="[NOPBlock]&lt;Murblock&gt;&lt;CapabilitisReplyBlock&gt;"/>
</node>
<node CREATED="1390989657040" ID="ID_1254819274" MODIFIED="1390989662500" TEXT="noopSet">
<node CREATED="1390989664146" ID="ID_1908729382" MODIFIED="1390989675643" TEXT="&lt;NOPBlock&gt;"/>
</node>
</node>
</node>
</node>
