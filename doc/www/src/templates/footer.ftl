    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">&copy; 2018 | <img src="https://www.gwerder.net/jenkins/buildStatus/icon?job=messageVortex&style=plastic"/> | Contact: <a href="mailto:info+hp_NO_at_SPAM_messagevortex_dot_com" id="email1">info+hp_NO_at_SPAM_messagevortex_dot_com</a></p>
      </div>
    </div>
