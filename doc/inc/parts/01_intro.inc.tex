...
\section{RQ1: Sending messages maintaining unlinkability against an adverser}
...
Within this questions we look at common attacks and test resistance of the protocol based on the definition of the protocol. We do this by first collecting well known attacks which are either generic or specific to a technology being used. We then try to elaborate if these attacks might be successful and if so under what circumstances.
