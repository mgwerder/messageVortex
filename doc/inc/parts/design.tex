...
I will use \defref{IMAP} as my hook to the mail account to maximize portability. The Solution is based on a \defref{IMAP} proxy server able to join encrypted delivered data with ordinary data.\par
