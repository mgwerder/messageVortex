...
\begin{document}
	\begin{figure}[!h]
	\centering\includegraphics[width=\columnwidth]{../../../website/src/main/jbake/assets/images/MessageVortexLogo_huge.png}
    ...
    {\fontfamily{lmss}\selectfont%\renewcommand{\bfdefault}{bx}\bf
     Message\includegraphics[height=1.1\fontcharht\font`V]{../website/src/main/jbake/assets/images/MessageVortexLogo_huge.png}ortex}
