...
\documentclass[a4paper,appendixprefix,pdfusetitle,twocolumn,fontsize=8pt,attachdocs,draft,status=draft]{scrbook}
...
%enable hyperlinks
\usepackage[hidelinks,bookmarks,hyperindex,hyperfigures,pdfpagelabels,pdftex,pdfa]{hyperref}
\makeatletter
\hypersetup{	
	pdftitle={\thetitle},
