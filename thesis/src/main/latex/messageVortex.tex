...
\usepackage[paper=a4paper,top=3cm,bottom=3cm,inner=3cm,outer=3cm]{geometry}% http://ctan.org/pkg/geometry
...
\gdef\MessageVortex{\emph{\defref{MessageVortex}}}
\gdef\VortexMessage{\emph{\defref{VortexMessage}}}
\gdef\VortexMessages{\emph{\defref{VortexMessage}s}}
