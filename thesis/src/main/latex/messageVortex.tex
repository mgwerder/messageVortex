...
\documentclass[a4paper,appendixprefix,pdfusetitle,twocolumn,fontsize=12pt,DIV=calc,12pt,draft,utf8]{\doctype} %scrbook
...
% fix some fonts
\usepackage{sansmath}                  % Maths without seroifes
...
\title{MessageVortex}
\subtitle{Transport Independent, Unobservable, and Unlinking Messaging}
\author{Martin Gwerder (06-073-787)}
\date{\gitAuthorDate}
...
\gdef\MessageVortex{\texorpdfstring{\emph{\defref{MessageVortex}}}{MessageVortex}}
