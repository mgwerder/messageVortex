...
\begin{entry}
  \mainentry{adversary}{\fxfatal{add content here}}
\end{entry}

\begin{entry}
	\mainentry{anonymity}{\fxfatal{add content here}}
	\subentry{Sender Anonymity}{\fxfatal{add content here}}
	\subentry{Receiver Anonymity}{\fxfatal{add content here}}
\end{entry}

\begin{entry}
	\mainentry{detectability}{\fxfatal{add content here}}
\end{entry}

\begin{entry}
  \mainentry{Agent}{\fxfatal{add content here}}
\end{entry}
...
\begin{entry}
	\mainentry{Item of Interest (IoI)}{\fxfatal{add content here}}
\end{entry}
...
\begin{entry}
  \mainentry{mail server admin}{\fxfatal{add content here}}
\end{entry}
...
\begin{entry}
  \mainentry{MS-OXMAPIHTTP}{\fxfatal{add content here}}
\end{entry}
...
\begin{entry}
  \mainentry{Service}{\fxfatal{add content here}}
\end{entry}
...
\begin{entry}
  \mainentry{user}{\fxfatal{add content here}}
\end{entry}

\begin{entry}
  \mainentry{UBE}{\fxfatal{add content here}}
\end{entry}
