...
\citename{rfc5321}\cite{rfc5321} furthermore introduces a simplistic model for SMTP message-based communication. A more comprehensive model is presented in section \nameref{sec:mailTransport} as the proposed model is not sufficient for a detailed end-to-end analysis.
...
%
%\section{Minimizing the Memory Footprint of Transactions}
%\fxwarning{complete section}
