...
\begin{figure}[ht]
	\lstinputlisting[linerange={18-84},language=asn.1,multicols=2]{asn/MessageVortex-Ciphers.asn}
...
\begin{figure}[ht]
	\lstinputlisting[linerange={86-95},language=asn.1]{asn/MessageVortex-Ciphers.asn}
...
\begin{figure}[ht]
	\lstinputlisting[linerange={97-104},language=asn.1]{asn/MessageVortex-Ciphers.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[language=asn.1,multicols=2]{asn/MessageVortex-NonProtocolBlocks.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={50-84},language=asn.1,multicols=2]{asn/MessageVortex-Schema.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={85-173},language=asn.1,multicols=2]{asn/MessageVortex-Schema.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={9-18},language=asn.1]{asn/MessageVortex-Requests.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={15-55},language=asn.1,multicols=2]{asn/MessageVortex-Replies.asn}
	\caption{Definition of a request.}
	\label{fig:defReply}
\end{lstfloat}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={19-22},language=asn.1]{asn/MessageVortex-Requests.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={9-34},language=asn.1,multicols=2]{asn/MessageVortex-Requirements.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={23-30},language=asn.1]{asn/MessageVortex-Requests.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={10-23},language=asn.1]{asn/MessageVortex-Helpers.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={61-91},language=asn.1]{asn/MessageVortex-Replies.asn}
...
\begin{lstfloat}[ht]
	\lstinputlisting[linerange={85-114},language=asn.1,multicols=2,basicstyle=\tiny]{asn/MessageVortex-Schema.asn}
