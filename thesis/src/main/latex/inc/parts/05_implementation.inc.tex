...
We decided to define fixed key sizes for symmetric ciphers as we went with block ciphers. We encode the key length in the asymmetric ciphers' parameters as they are due to their differences far more often flexible.
