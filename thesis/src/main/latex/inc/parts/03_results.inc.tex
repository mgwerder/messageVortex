...
\begin{itemize}
	...
	\item Routing updating: Event based\footnote{Only partially correct, as there is no such thing as an update to routing information update.}
	...
	\item Communication node selection selection probability: uniform \fxwarning{may be any; recheck}
	...
	\item Performance context: messaging
\end{itemize}
