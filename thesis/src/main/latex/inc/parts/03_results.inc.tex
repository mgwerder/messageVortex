...
To diagnose the flow of a message any part of the message may be sent directly or indirectly back to the routing block builder allowing him to judge upon the message progress and whether nodes are well behaving or not.

There is no fingerprinting operation available for doing such diagnosis as it would have made the traffic identifiable as diagnostic traffic.
