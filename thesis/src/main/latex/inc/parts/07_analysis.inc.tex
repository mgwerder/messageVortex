...
Assuming a global observer as an adversary and unencrypted traffic, %FIXME is the global observer both?
...
\begin{itemize}
	...
	A standard protocol on the Internet is DNS. Almost all network-related programs use it without thinking. %FIXME network programs don't think
...
\begin{itemize}
	...
	Messages were equally sized into 32KB junks.%FIXME do you mean chunks?
