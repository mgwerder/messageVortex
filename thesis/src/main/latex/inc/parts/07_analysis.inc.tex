...
\section{Routing}
The basics of routing is described in \cref{sec:routingLayer}. We collect in the following sections the recommendations regarding the routing strategies.
...
Furthermore, predeployed diagnosis blocks within the message path are a good possibility simplify the possibility of explicit routing diagnosis.
