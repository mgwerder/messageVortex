...
So far the Riffle system has not attracted much interest in the academic world. While being extended, no valid attack was discovered so far.
...
Atom\cite{kwon2016atom} is an asynchronous anonymity service for small messages claiming to be scaleable and transferring up to a million tweet sized messages in 28 minutes.

\fxwarning{Add and classify Atom}%
