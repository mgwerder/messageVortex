...
\hiddensection{SMTP and Related Post Office Protocols (1982)}\label{sec:mailTransport}\index{email}
...
\section{S/MIME (1996)}\index{s/mime}
...
\section{Pretty Good Privacy (1996)}\index{PGP}
...
\section{Mixing}\label{sec:mixNets}\index{mixnet}
...
\section{Anonymous Remailers}\label{sec:remailers}\index{remailer}
...
\section{Onion Routing}\index{onion routing}
...
\section{Garlic Routing}\index{garlic routing}
...
\section{Mimic Routes}\index{mimic routes}
...
\section{Distributed Hash Tables}\index{DHT}\index{distributed hash tables|see {DHT}}
...
\section{Dining Cryptographer Networks}\index{DC network}
...
\section{Private Information Retrieval}\index{PIR}
...
\subsection{Pseudonymous Remailers (1981)\label{sec:remPseudo}}\index{remailer!pseudonymous}
...
\subsection{Cypherpunk Remailers (approx. 1993)\label{sec:remCypherpunk}}\index{remailer!cypherpunk}
...
\subsection{Babel (1996)}\index{Babel}
...
\subsection{Mixmaster-Remailers (1996)\label{sec:remMixmaster}}\index{remailer!Mixmaster}
...
\subsection{Crowds (1997)}\index{Crowds}
...
\subsection{Tor (2000)}\label{sec:tor}\index{Tor}
...
\subsection{\texorpdfstring{$I^2P$}{I2P} (2001)}\index{I2P}
...
\subsection{Mixminion-Remailers (2002)\label{sec:remMixminion}}\index{remailer!Mixminion}
...
\subsection{\texorpdfstring{$\mathcal{P}^5$}{P5} (2002)}\index{P5}\index{peer-to-peer privacy protocol|see {P5}}
...
\subsection{AN.ON (2003)}\index{AN.ON}
...
\subsection{Cashmere (2005)}\index{Cashmere}
...
\subsection{SOR (2012)}\index{SOR}\index{ssh based onion routing|see {SOR}}
...
\subsection{PGA (2013)}\index{PGA}\index{Pretty Good Anonymity|see {PGA}}
...
\subsection{Vuvuzela (2015)}\index{Vuvuzela}
...
\subsection{Riffle (2016)}\index{Riffle} %Mix
...
\subsection{MCMix (2017)}\index{MCMix}
...
\subsection{SCION (2017)}\index{SCION}
...
\subsection{Karaoke (2018)}\index{Karaoke}
...
\subsection{Riposte (2015)}\index{Riposte}
...
\subsection{Pung (2016)}\index{Pung}
...
\subsection{Tarzan (2002)}\index{Tarzan}
...
\subsection{MorphMix (2002)}\index{MorphMix}
...
\subsection{Salsa (2008)}\index{Salsa}
...
\subsection{Herbivore (2003)}\index{Herbivore}
...
\subsection{Dissent (2010)}\index{Dissent}
...
\subsection{Verdict (2013)}\index{Verdict}
...
\subsection{Hordes (2002)}\index{Hordes}
...
\subsection{Atom (2016)}\index{Atom}
...
\subsection{Freenet (2000)}\index{Freenet}
...
\subsection{Gnutella (2000)}\index{Gnutella}
...
\subsection{Gnutella2 (2002)}\index{Gnutella2}
