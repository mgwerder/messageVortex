...
% Text Node
\draw (1163.41,313.32) node  [font=\small,rotate=-270,xscale=2,yscale=2]  {\textcolor{white}{$PAYLOAD_{0}$}};
% Text Node
\draw (1243.25,313.32) node  [font=\small,rotate=-270,xscale=2,yscale=2]  {\textcolor{white}{$PAYLOAD_{1}$}};
% Text Node
\draw (1447.04,313.32) node  [font=\small,rotate=-270,xscale=2,yscale=2]  {\textcolor{white}{$PAYLOAD_{p-1}$}};
% Text Node
