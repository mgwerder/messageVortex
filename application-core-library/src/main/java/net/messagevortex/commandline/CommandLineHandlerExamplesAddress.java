...
public class CommandLineHandlerExamplesAddress implements Callable<Integer> {
  ...
  public Integer call() throws Exception {
    ...
    LOGGER.log(Level.INFO, "Address is: vortex" +protocol+"://" + address.substring(0,address.indexOf('@'))+".."+ Base64.getEncoder().encodeToString(key.toAsn1Object(DumpType.PUBLIC_ONLY).getEncoded())+ ".."+address.substring(address.indexOf('@')+1)+"@localhost");
